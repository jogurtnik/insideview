...
public class JSHDataFormat implements DataFormat {
    ...
    private static final String[] XLSX_DATA_COLUMS_HEADERS = {"County", "Meeting", "Distance", "Time", "Horse", "Status",
    ...
    private String[] customDataColumsHeaders;

    private static final int XLSX_SHEET_NUMBER = 0;

    @Override
    public void setCustomDataColumsHeaders(String[] customDataColumsHeaders) {
        this.customDataColumsHeaders = customDataColumsHeaders;
    }

    @Override
    public String[] getCustomDataColumsHeaders() {
        return customDataColumsHeaders;
    }

    @Override
    public String[] getDefaultDataColumnsHeaders() {
        return XLSX_DATA_COLUMS_HEADERS;
    }
